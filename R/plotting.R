...
makePie <- function(sigs.output, sub = "", v3 = FALSE, add.color = NULL) {
  ...
  all.sigs <- c(
    "Signature.1", "Signature.1A", "Signature.1B", "Signature.2", "Signature.3", "Signature.4",
  ...
  all.colors <- c(
    "#023FA5", "#023FA5", "#7D87B9", "#BEC1D4", "#D6BCC0", "#BB7784",
  ...
  if (v3 == TRUE) {
    ...
    all.colors <- c(tmp_color[c(
      405, 420, 358, 143, 427, 379, 355, 144, 123, 220,
